class CountriesController < ApplicationController
  ...
  private
    ...
    def country_params
      params.expect(country: [ :name, :short_name, :native_name, :iso2, :iso3, :phone_code, :currency, :currency_name, :currency_symbol, :timezone, :translations, :flag, :wiki_data_id, :region_id, :active ])
    end
end
