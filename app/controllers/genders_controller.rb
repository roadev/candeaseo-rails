class GendersController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to genders_path, status: :see_other, notice: "Gender was successfully destroyed." }
  ...
  private
    ...
    def gender_params
      params.expect(gender: [ :name, :short_name, :display_order, :active ])
    end
end
