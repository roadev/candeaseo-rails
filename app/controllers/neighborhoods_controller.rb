class NeighborhoodsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to neighborhoods_path, status: :see_other, notice: "Neighborhood was successfully destroyed." }
  ...
  private
    ...
    def set_neighborhood
      @neighborhood = Neighborhood.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def neighborhood_params
      params.expect(neighborhood: [ :name, :township_id, :active ])
    end
end
